  ...
  <div class="row">
    <div class="col-md-3">
      ...
      <div class="form-group">
        ...
        <input class="form-control" placeholder="Enter your date of birth" type="date" v-model="userDob">
      </div>

      <div class="form-group">
        <label for="description"> ID Upload</label><br>

          <input type="file" @change="captureFile">
          <button class="btn btn-primary" @click="uploadToIpfs">Upload</button><br>
          <label for="description">{{userIpns}}</label>
...
export default {
  ...
  methods: {
    ...
    async uploadToIpfs(){
      ...
      // })
      // this.dr=  this.makingfolder()
      // console.log("d:",this.dr);
      console.log("aaya");
        console.log('hash',hashedText);
        this.userIpns=hashedText[0].hash
    },
    ...
    //   console.log('testing .....');
    //
    //   await ipfs.files.mkdir('/my/dir/',(err,drr)=>{
    //     if(err){
    //       console.log("e",err)}
    //     return drr
    //
